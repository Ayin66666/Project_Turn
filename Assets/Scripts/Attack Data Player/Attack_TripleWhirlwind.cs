...
public class Attack_TripleWhirlwind : Attack_Base
{
    ...
    private IEnumerator Attack()
    {
        ...
        while (a < refCount)
        {
            ...
            if (target.GetComponent<Enemy_Base>().isDie)
            {
                ...
                anim.SetBool("isTripleWhirlwindAttack", false);
                while (anim.GetBool("isTripleWhirlwindAttack"))
                {
                    yield return null;
                }
            ...
            else
            {
                ...
                anim.SetBool("isTripleWhirlwindAttack", true);
